...
public class MyPlayerController : PlayerController
{
    ...
    void GetKeyInput()
    {
        ...
        {
            GameObject go = Managers.Resource.Instantiate("Equipments/ProtectedGear");
        ...
        {
            GameObject go = Managers.Resource.Instantiate("Equipments/Mask");
            C_Equip equipPacket = new C_Equip();
            equipPacket.ItemName = go.name;
            Managers.Network.Send(equipPacket);
            go.GetComponent<Equipment>().Equip(this);
        ...
        {
            GameObject go = Managers.Resource.Instantiate("Equipments/ShoeCover");
            C_Equip equipPacket = new C_Equip();
            equipPacket.ItemName = go.name;
            Managers.Network.Send(equipPacket);
            go.GetComponent<Equipment>().Equip(this);
        ...
        {
            GameObject go = Managers.Resource.Instantiate("Equipments/Goggle");
            C_Equip equipPacket = new C_Equip();
            equipPacket.ItemName = go.name;
            Managers.Network.Send(equipPacket);
            go.GetComponent<Equipment>().Equip(this);
